            ...
            <div class="container-fluid">
                <div class="row bg-title">
                    <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                        <h4 class="page-title">Add Services</h4> </div>
                                        ...
                                        <div class="col-md-12 ">
                                            <div class="row">
                                                <div class="col-sm-12 col-xs-12">
                                                    <form id="form" action="<?php echo base_url(); ?>admin/cms/serives_add" method="POST" enctype='multipart/form-data' class="form-material">
                                                       <div class="form-group">
                                                            <h2>Add Services</h2>
                                                            <select id="inputState" class="form-control" id="services" name="services">
