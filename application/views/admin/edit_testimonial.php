            ...
            <div class="container-fluid">
                <div class="row bg-title">
                    <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                        <h4 class="page-title">Edit Testimonial</h4> </div>
                                        ...
                                        <div class="col-md-12 ">
                                            <div class="row">
                                                <div class="col-sm-12 col-xs-12">
                                                    <form action="<?php echo base_url(); ?>admin/cms/update_testimonial/<?= $this->uri->segment(4) ?>" method="POST" enctype='multipart/form-data' class="form-material">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <textarea class="ckeditor" name="description"><?= $testimonial->description ?></textarea>
                                                        </div>
                                                        <div class="form-group">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <img src="<?= base_url() ?>uploads/testimonials/<?= $testimonial->image ?>" width="150">
                                                        </div>
