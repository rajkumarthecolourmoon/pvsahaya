            ...
            <div class="container-fluid">
                <div class="row bg-title">
                    <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                        <h4 class="page-title">Why Steam Wash</h4> </div>
                                        ...
                                        <div class="col-md-12 ">
                                            <div class="row">
                                                <div class="col-sm-12 col-xs-12">
                                                    <form action="<?php echo base_url(); ?>admin/cms/update_steam_wash" method="POST" enctype='multipart/form-data' class="form-material">
                                                        <div class="form-group">
                                                            <label for="name">Description-1</label>
                                                            <textarea class="ckeditor" name="description1" ><?= $row->description1 ?></textarea>
                                                        </div>
                                                        <div class="form-group">
                                                            <label for="name">Description-2</label>
                                                            <textarea class="ckeditor" name="description2" ><?= $row->description2 ?></textarea>
                                                        </div>
                                                        <div class="form-group">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <img src="<?= base_url() ?>uploads/<?= $row->image ?>" width="300" alt="No-Image">
                                                        </div>
                                                        <div class="row">
                                                            <div class="col-md-12">
