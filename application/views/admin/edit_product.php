            ...
            <div class="container-fluid">
                <div class="row bg-title">
                    <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                        <h4 class="page-title">Edit-Product Details</h4> </div>
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="white-box">
                                ...
                                <p class="text-muted m-b-30 font-13"> Edit-Products</p>
                                <div id="exampleValidator" class="wizard">
                                    <ul class="wizard-steps" role="tablist">
                                        ...
                                        <li role="tab">
                                            <h4><span><i class="ti-image"></i></span>Select Brand</h4>
                                        </li>
                                    </ul>

                                    <form id="validation"  class="form-horizontal" action="<?php echo base_url(); ?>admin/products/update_product/<?= $this->uri->segment(4) ?>" method="POST" enctype='multipart/form-data'>
                                        <div class="wizard-content">
                                            <div class="wizard-pane active" role="tabpanel">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-control subCat" name="sid" onchange="getsubsubcat();">
                                                        <?php foreach ($sub_category as $sub_category) { ?>
                                                            ...
                                                            if ($sub_category->id == $products->sid) {
                                                                echo "selected";
                                                            }
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-control subsubcat" name="ssid" onchange="getfilters();">
                                                        <?php foreach ($sub_sub_categories as $sub_sub_category) { ?>
                                                            <option value="<?= $sub_sub_category->id ?>" <?php
                                                            if ($sub_sub_category->id == $products->ssid) {
                                                                echo "selected";
                                                            }
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="name" class="form-control" id="name" placeholder="Title" value="<?php echo $products->name; ?>"> 
                                                </div>
                                                <div class="form-group">
                                                    <label for="name">Offer</label>
                                                    <select class="form-control offer_selector" name="offer">
                                                        <option value="no" <?php
                                                        if ($products->offer == 'no') {
                                                            echo 'selected';
                                                        }
                                                        ?>>No</option>
                                                        <option value="yes" <?php
                                                        if ($products->offer == 'yes') {
                                                            echo 'selected';
                                                        }
                                                        ?> >Yes</option>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="mrp_price" class="form-control" id="name" placeholder="" value="<?php echo $products->mrp_price; ?>"> 
                                                </div>
                                                <div class="form-group">
                                                    <label for="name">Sale Price</label>
                                                    <input type="text" name="sale_price" class="form-control sale_price_selector" id="name" placeholder="" value="<?php echo $products->sale_price; ?>" <?php
                                                    if ($products->offer == 'no') {
                                                        echo 'disabled';
                                                    }
                                                    ?>> 
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-control" name="vendorid" onchange="getlat_lng();" id="vendor_id">
                                                        ...
                                                        <?php foreach ($vendors as $vendor) { ?>
                                                            ...
                                                            if ($vendor->id == $products->vendorid) {
                                                                echo "selected";
                                                            }
                                                            ?> ><?= $vendor->vendor_buisiness_name ?></option>
                                                                <?php } ?>
                                                    </select>
                                                </div>
                                                <div class="form-group">
                                                    <label for="exampleInputEmail1">Latitude</label>
                                                    <input type="text"  name="latitude" class="form-control latitude"  value="<?php echo $products->latitude; ?>"> 
                                                </div>
                                                <div class="form-group">
                                                    <label for="exampleInputEmail1">Longitude</label>
                                                    <input type="text"  name="longitude" class="form-control longitude"  value="<?php echo $products->longitude; ?>"> 
                                                </div>
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-control" name="availability">
                                                        ...
                                                        <option value="yes" <?php
                                                        if ($products->availability == 'yes') {
                                                            echo 'selected';
                                                        }
                                                        ?> >Yes</option>
                                                        <option value="no" <?php
                                                        if ($products->availability == 'no') {
                                                            echo 'selected';
                                                        }
                                                        ?> >No</option>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <textarea rows="5" cols="10" class="form-control" id="short_description" name="short_description"><?php echo $products->short_description; ?></textarea>
                                                </div>
                                                <div class="form-group">
                                                    <label for="exampleInputEmail1">Description</label>
                                                    <textarea rows="5" cols="10" class="ckeditor" id="description" name="description"><?php echo $products->description; ?></textarea>
                                                </div>

                                                <div class="form-group">    
                                                    <label for="exampleInputEmail1">Specification</label>
                                                    <textarea rows="5" cols="10" class="ckeditor" id="specification" name="specification"><?php echo $products->specification; ?></textarea>
                                                </div>
                                                <div class="form-group">
                                                    <label for="exampleInputEmail1">Youtube Link</label>
                                                    <input type="text"  name="youtube_link" class="form-control"  value="<?php echo $products->youtube_link; ?>"> 
                                                </div>
                                            </div>
                                            <div class="wizard-pane" role="tabpanel">

                                                <div class="append_filters">
                                                    <div class='form-group'>
                                                        <?php foreach ($product_filters as $product_filter) { ?>
                                                            <label for='name'><?= $product_filter->filter_group_name ?></label>
                                                            <input type='hidden' value='<?= $product_filter->filter_group_id ?>' name='filter_group_id[]'>
                                                            <select class='form-control filgr' name='filter_value_id[]'>
                                                                <option value=''>--Select--</option>
                                                                <?php foreach ($product_filter->filter_values as $filter_value) { ?>
                                                                    <option value='<?= $filter_value->id ?>' <?php
                                                                    if ($product_filter->filter_value_id == $filter_value->id) {
                                                                        echo "selected";
                                                                    }
                                                                    ?>><?= $filter_value->name ?></option>
                                                                        <?php } ?>
                                                            </select>
                                                        <?php } ?>
                                            ...
                                            <div class="wizard-pane" role="tabpanel">
                                                <strong class="text-left">Select Brands</strong>
                                                <div class="form-group">
                                                    <?php foreach ($brands as $brand) { ?>
                                                        <div class="col-xs-5">
                                                            <div class="radio radio-success">
                                                                <input type="radio" name="brand_id" id="radio<?= $brand->id ?>" value="<?= $brand->id ?>" <?php
                                                ...
                                                <div class="form-group">
                                                    <div class="radio radio-success form-group cbhorz">
                                                        ...
                                                        foreach ($tags as $tag) {
                                                            ?>
                                                            <input id="checkbox<?= $i ?>" type="radio" name="tag_id" value="<?= $tag->id ?>" <?= $tag->id == $products->tag_id ? 'checked' : '' ?>>
                                                ...
                                                <div class="form-group">
                                                    <div class="checkbox checkbox-success form-group">
                                                        ...
                                                        <input id="hot_deal" type="checkbox" name="tags" value="hot_deals" <?= $products->tags == 'hot_deals' ? 'checked' : '' ?>>
                                        ...
                                        <button id="mysubmit" type="submit" class="fcbtn btn btn-success btn-outline btn-1d" >Update Details</button>
                                </div>
                            </div>
                            </form>
                        </div>
