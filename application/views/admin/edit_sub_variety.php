                                        ...
                                        <div class="col-md-12 ">
                                            <div class="row">
                                                <div class="col-sm-12 col-xs-12">
                                                    <form action="<?php echo base_url(); ?>admin/cms/update_sub_variety/<?= $this->uri->segment(4) ?>/<?= $this->uri->segment(5) ?>" method="POST" enctype='multipart/form-data' class="form-material">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <img src="<?= base_url() ?>uploads/varieties/<?= $row->image ?>" width="500" alt="No Image">
                                                        </div>
                                                        <div class="form-group">
