                                        ...
                                        <div class="col-md-8 ">
                                            <div class="row">
                                                <div class="col-sm-12 col-xs-12">
                                                    <form action="<?php echo base_url(); ?>admin/seo/update_meta_tags_location/<?= $this->uri->segment(4) ?>" method="POST" enctype='multipart/form-data' class="">
                                                        <div class="form-group">
                                                            <label for="name">Location Name</label>
                                                            <input type="text" readonly="readonly" class="form-control" id="name" placeholder="Title" value="<?= $location->name ?>"> </div>
