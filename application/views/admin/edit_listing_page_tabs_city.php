                                        ...
                                        <div class="col-md-12 ">
                                            <div class="row">
                                                <div class="col-sm-12 col-xs-12">
                                                    <form action="<?php echo base_url(); ?>admin/seo/update_listing_page_tab_city/<?= $this->uri->segment(4) ?>/<?= $this->uri->segment(5) ?>" method="POST" enctype='multipart/form-data' class="">
