                                        ...
                                        <div class="col-md-6 ">
                                            <div class="row">
                                                <div class="col-sm-12 col-xs-12">
                                                    <form action="<?php echo base_url(); ?>admin/categories/insert_filter_value" id="post_form" method="POST" enctype='multipart/form-data' class="form-material" >
                                                        ...
                                                        <div class="form-group">
                                                            <label for="name">Select Filter Value</label>
