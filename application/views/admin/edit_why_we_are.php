                                        ...
                                        <div class="col-md-12 ">
                                            <div class="row">
                                                <div class="col-sm-12 col-xs-12">
                                                    <form action="<?php echo base_url(); ?>admin/cms/update_why_we_are/<?= $this->uri->segment(4) ?>" method="POST" enctype='multipart/form-data' class="form-material">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" name="sub_title" class="form-control" value="<?= $row->sub_title ?>">
                                                        </div>
