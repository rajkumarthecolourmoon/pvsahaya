            ...
            <div class="container-fluid">
                <div class="row bg-title">
                    <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                        <h4 class="page-title">Edit Filter Value(Sub SubCategory)</h4> </div>
                                        ...
                                        <div class="col-md-6 ">
                                            <div class="row">
                                                <div class="col-sm-12 col-xs-12">
                                                    <form action="<?php echo base_url(); ?>admin/categories/update_filter_value_sub_sub_category" method="POST" enctype='multipart/form-data' class="form-material">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <select class="form-control mainCat" name="cid" onchange="getSub();">
                                                                ...
                                                                <?php foreach ($categories as $category) {
                                                                    ...
                                                                    if ($filter_value->cid == $category->id) {
                                                                        echo "selected";
                                                                    }
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <select class="form-control subCat" name="ssid" onchange="getFilter();">
                                                                <?php foreach ($sub_sub_categories as $sub_category) { ?>
                                                                    ...
                                                                    if ($filter_value->ssid == $sub_category->id) {
                                                                        echo "selected";
                                                                    }
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <select class="form-control filterValue" name="ffid">
                                                                <?php foreach ($filter_groups as $filter_group) { ?>
                                                                    <option value="<?= $filter_group->id ?>" <?php
                                                                    if ($filter_value->fid == $filter_group->id) {
                                                                        echo "selected";
                                                                    }
