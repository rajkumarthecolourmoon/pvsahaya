            ...
            <div class="container-fluid">
                <div class="row bg-title">
                    <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                        <h4 class="page-title">Add Locations</h4> </div>
                                        ...
                                        <div class="col-md-6 ">
                                            <div class="row">
                                                <div class="col-sm-12 col-xs-12">
                                                    <form action="<?php echo base_url(); ?>admin/categories/insert_location" method="POST" enctype='multipart/form-data' class="">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" name="name" class="form-control" id="name" placeholder="Title" > </div>
                                                            ...
                                                            <?php foreach ($lead_types as $lead_type) { ?>
                                                                ...
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col-md-3">
                                                                        ...
                                                                        <input type="text" class="form-control" name="price[<?= $lead_type->id ?>][]"> 
                                                                    </div>
                                                                    <div class="col-md-3">
