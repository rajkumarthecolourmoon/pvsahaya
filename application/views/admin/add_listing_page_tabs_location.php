            ...
            <div class="container-fluid">
                <div class="row bg-title">
                    <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                        <h4 class="page-title">Add Tab</h4> </div>
                                        ...
                                        <div class="col-md-12 ">
                                            <div class="row">
                                                <div class="col-sm-12 col-xs-12">
                                                    <form action="<?php echo base_url(); ?>admin/seo/insert_listing_page_tab_location/<?= $this->uri->segment(4) ?>" method="POST" enctype='multipart/form-data' class="">
                                                        <div class="form-group">
                                                            <label for="name">Select Lead Type</label>
